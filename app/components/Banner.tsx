...
// const Banner = () => {
//     return (
//         <div className="relative w-full min-h-screen bg-gradient-to-br from-teal-950 to-teal-800">
//             {/* grid overlay */}
//             <div className="absolute inset-0 bg-[linear- 
//             gradient(to_right,#1f2937_1px,transparent_1px),
//             linear-gradient(to_bottom,#1f2937_1px,transparent_1px)] bg-[size:4rem_4rem] opacity-25"/>
...
//                         {/* <Image src="/arrow-right.png" alt="arrow-right" width={50} height={50} className="px-8 py-3 rounded-50% bg-white" /> */}
//                     </button>
...
//             {/* Partner Companies */}
//             <div className="relative max-w-7xl mx-auto px-6 md:px-12 py-8 flex items-center justify-between">
